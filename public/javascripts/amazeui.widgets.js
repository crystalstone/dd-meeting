/*! Amaze UI v1.0.0-beta2 ~ widgets | by Amaze UI Team | (c) 2014 AllMobilize, Inc. | Licensed under MIT | 2014-09-28T06:09:57 UTC */ 
...
define("ui.modal", [ "core", "zepto.extend.fx", "zepto.extend.data", "zepto.extend.selector", "ui.dimmer" ], function(require, exports, module) {
    require("core");
    var dimmer = require("ui.dimmer"), $ = window.Zepto, UI = $.AMUI, $doc = $(document), supportTransition = UI.support.transition;
    /**
...
seajs.use(["core","util.fastclick","util.hammer","zepto.outerdemension","zepto.extend.data","zepto.extend.fx","zepto.extend.selector","ui.add2home","ui.collapse","ui.dimmer","ui.iscroll-lite","ui.modal","ui.offcanvas","ui.pureview","ui.share","ui.smooth-scroll","ui.tabs","util.cookie","util.qrcode","zepto.flexslider","zepto.pinchzoom","accordion","divider","duoshuo","figure","footer","gallery","gotop","header","intro","list_news","map","mechat","menu","navbar","pagination","paragraph","slider","sohucs","tabs","titlebar"]);